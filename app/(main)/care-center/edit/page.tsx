  ...
  return (
    <AppLayout>
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-2xl shadow-purple-200/40 border-4 border-purple-400/70 p-12 md:p-16 space-y-10 backdrop-blur-sm">
          {/* 요양원 이름 */}
          <div>
